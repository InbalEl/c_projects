...
-   19/06/20 11:00  Ver:  1.2  fixing: removing "const" from void *data in 
									  DListSetData,
                                      "Dlist" where "Slist" was still written
-   19/06/20 13:30  Ver:  1.3  fixing: removing "const" from void *data in 
									  do_action, Insert, PushFront, PushBack.
                                      Adding "const" to void *data  is_match.
-   23/06/20 16:30  Ver:  1.4  fixing: removing "const" from all iterators
*/
